...
{   //functions have statemens. Statements are instructions that causes the program to make actions
    ...
    *This program inputs to two variables (this time as separate statements). We’ll run this program twice.
    ...
    int ss{}; // define variable x to hold user input
    std::cin >> ss; // get number from keyboard and store it in variable ss
    std::cout << "You entered " << ss << '\n';
    // max value of an integer is 2147483647. If something bigger entered, it will automatically be turned into 2147483647

    int birinci;
    int ikinci;
    int ucuncu;
    std::cout << "last question: enter three numbers";
    std::cin >> birinci >> ikinci >> ucuncu;
    std::cout << birinci << " - " << ikinci << " - " << ucuncu << " ended.";
